...
async function getAllDepartments() {
    try {
        ...
        const { data: doctors, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('doctors').select('specialization').eq('status', 'active');
        if (error) {
            console.error('Error fetching doctors:', error);
...
async function updateDoctor(doctorId, updates) {
    try {
        ...
        const { data: existingDoctor, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('doctors').select('user_id').eq('id', doctorId).single();
        if (fetchError) {
        ...
        if (Object.keys(userFields).length > 0) {
            const { error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').update(userFields).eq('id', existingDoctor.user_id);
            if (userError) {
        ...
        if (Object.keys(doctorFields).length > 0) {
            const { error: doctorError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('doctors').update(doctorFields).eq('id', doctorId);
            if (doctorError) {
        ...
        const { data: updatedDoctor, error: selectError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('doctors').select(`
        *,
        user:users(id, name, email, phone, address)
...
"[project]/components/DoctorForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        ].map((session)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "relative",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                        type: "checkbox",
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            'Fri',
                                                            'Sat'
                                                        ].map((day, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                type: "button",
...
var _c;
__turbopack_context__.k.register(_c, "DoctorForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/doctors/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DoctorForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DoctorForm.tsx [app-client] (ecmascript)");
;
...
function DoctorsPage() {
    ...
    const [selectedSpecialization, setSelectedSpecialization] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('All Specializations');
        ...
        "DoctorsPage.useEffect": ()=>{
            ...
            if (searchTerm) {
                filtered = filtered.filter({
                    "DoctorsPage.useEffect": (doctor)=>doctor.user?.name.toLowerCase().includes(searchTerm.toLowerCase()) || doctor.specialization.toLowerCase().includes(searchTerm.toLowerCase()) || doctor.license_number.toLowerCase().includes(searchTerm.toLowerCase())
                }["DoctorsPage.useEffect"]);
            }
            if (selectedSpecialization !== 'All Specializations') {
                filtered = filtered.filter({
                    "DoctorsPage.useEffect": (doctor)=>doctor.specialization === selectedSpecialization
                }["DoctorsPage.useEffect"]);
            }
    ...
    const loadDoctors = async ()=>{
        try {
            setLoading(true);
            const doctorsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllDoctorsSimple"])();
            ...
            const today = new Date().toISOString().split('T')[0];
            const { data: appointmentsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('appointments').select('id').eq('appointment_date', today).eq('status', 'completed');
            setStats({
                totalDoctors,
                onDuty,
    ...
    const loadSpecializations = async ()=>{
        try {
            const specs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllSpecializations"])();
    ...
    const loadDepartments = async ()=>{
        try {
            const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllDepartments"])();
    ...
    const handleAddDoctor = async ()=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDoctor"])(doctorData);
    ...
    const handleEditDoctor = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoctor"])(selectedDoctor.id, formData);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            getSessionTimings(doctor).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-xs text-gray-600",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    getSessionTimings(doctor).map((session, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            filteredDoctors.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DoctorForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                isOpen: showAddModal,
                onClose: ()=>{
                    setShowAddModal(false);
                    resetForm();
...
_s(DoctorsPage, "wx4akBKav5TelzTxB5qx/C20ssM=");
_c = DoctorsPage;
var _c;
...
//# sourceMappingURL=_7c6eccb3._.js.map