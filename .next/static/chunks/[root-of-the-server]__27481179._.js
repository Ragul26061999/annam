...
const LoginPage = ({ onLogin })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["signInWithEmail"])(email, password);
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27481179._.js.map